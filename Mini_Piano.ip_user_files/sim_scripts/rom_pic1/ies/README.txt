...
#
# Generated by export_simulation on Wed Dec 27 16:30:11 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rom_pic1.sh' script.

./rom_pic1.sh -reset_run
...
./rom_pic1.sh -noclean_files

For more information on the script, please type './rom_pic1.sh -help'.
